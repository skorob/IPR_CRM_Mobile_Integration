...
public class TestSendContactFromCRMMobileToCRM {

	org.slf4j.Logger log = LoggerFactory.getLogger(TestSendContactFromCRMMobileToCRM.class);
		...
		try {
			...
			try {
				...
				try {
					...
					message.writeBytes(Resources.toString(Resources.getResource("json/Subscribe-Contact.json"), Charsets.UTF_8).getBytes());
